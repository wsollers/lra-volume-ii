\newpage
\phantomsection
\label{prf:rational-square-bracketing-grid}
\LRAProofFor{thm:rational-square-bracketing-grid}

\begin{remark*}[Return]
\hyperref[thm:rational-square-bracketing-grid]{Return to Theorem}
\end{remark*}
