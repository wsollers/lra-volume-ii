\newpage
\phantomsection
\label{prf:rational-square-approximation-from-above-grid}
\LRAProofFor{thm:rational-square-approximation-from-above-grid}

\begin{remark*}[Return]
\hyperref[thm:rational-square-approximation-from-above-grid]{Return to Theorem}
\end{remark*}
