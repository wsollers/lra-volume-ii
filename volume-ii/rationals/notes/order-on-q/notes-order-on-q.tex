...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{thm:positivity-on-q-well-defined}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{cor:addition-reflects-order-on-q}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{thm:negative-multiplication-reverses-strict-order-on-q}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{cor:negative-multiplication-reverses-order-on-q}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{thm:absolute-value-nonnegative-on-q}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{thm:absolute-value-zero-iff-on-q}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{thm:absolute-value-multiplicative-on-q}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{thm:absolute-value-of-reciprocal-q}.
\end{itemize}
\end{dependencies}
