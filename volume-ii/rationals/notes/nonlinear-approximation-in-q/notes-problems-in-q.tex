...
\begin{definitionbox}{Definition (Convergence of a Rational Sequence)}
...
\begin{definitionbox}{Definition (Equivalence of Cauchy Sequences in $\mathbb{Q}$)}
...
\begin{theorembox}{Theorem (The Cauchy Equivalence Relation on $\mathbb{Q}^c$)}
