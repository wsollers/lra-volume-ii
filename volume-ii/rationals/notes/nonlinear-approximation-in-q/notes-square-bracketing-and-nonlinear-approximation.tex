...
\label{thm:rational-square-bracketing-grid}
For every $r\in\mathbb{Q}$ with $r>0$, there exist $a,b\in\mathbb{Q}$ with
$a>0$ and $b>0$ such that
\[
a^2<r<b^2.
\]
\hyperref[prf:rational-square-bracketing-grid]{Go to proof.}
\end{theorem}
\end{tcolorbox}
...
\begin{itemize}
  ...
  \item \hyperref[thm:rational-square-bracketing-grid]{Rational Square Bracketing}
\end{itemize}
\end{dependencies}
...
\label{thm:rational-square-approximation-from-above-grid}
Let $r\in\mathbb{Q}$ with $r>0$, and let $n\in\mathbb{N}$ with $n\ge 1$.
Then there exists $s\in\mathbb{Q}$ with $s>0$ such that
\[
r<s^2<r+\frac1n.
\]
\hyperref[prf:rational-square-approximation-from-above-grid]{Go to proof.}
\end{theorem}
\end{tcolorbox}
...
\begin{dependencies}
\begin{itemize}
  \item \hyperref[thm:rational-square-approximation-from-above-grid]{Rational Square Approximation from Above}
\end{itemize}
\end{dependencies}
\end{topicbox}
