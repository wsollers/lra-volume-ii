...
\begin{theorembox}{Theorem (Rational Square Bracketing)}
...
\begin{theorembox}{Theorem (Rational Square Approximation from Above)}
...
\begin{theorembox}{Theorem (Rational Square Approximation from Below)}
