...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{thm:addition-on-q-associative}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{thm:zero-left-additive-identity-on-q}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{cor:zero-right-additive-identity-on-q}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{thm:zero-additive-identity-on-q}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{lem:negation-on-q-respects-equivalence}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{thm:negation-on-q-well-defined}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{thm:negation-left-additive-inverse-on-q}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{cor:negation-right-additive-inverse-on-q}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{thm:every-rational-has-additive-inverse}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{thm:subtraction-on-q-well-defined}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{thm:multiplication-on-q-associative}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{thm:one-left-multiplicative-identity-on-q}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{cor:one-right-multiplicative-identity-on-q}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{thm:one-multiplicative-identity-on-q}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{lem:nonzero-predicate-well-defined-q}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{def:division-on-q}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{thm:division-on-q-well-defined}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{thm:left-distributivity-on-q}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{cor:right-distributivity-on-q}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{thm:multiplication-distributes-over-addition-on-q}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{thm:q-additive-abelian-group}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{thm:q-nonzero-multiplicative-abelian-group}.
\end{itemize}
\end{dependencies}
