...
\begin{exposition}
The embeddings assemble into a single chain $\mathbb{N}\hookrightarrow\mathbb{W}\hookrightarrow\mathbb{Z}\hookrightarrow\mathbb{Q}\hookrightarrow\mathbb{R}$. Each arrow is injective, preserves arithmetic, and reflects order; each step also \emph{adds} structure that the previous system lacked.
\end{exposition}
\begin{exposition}
