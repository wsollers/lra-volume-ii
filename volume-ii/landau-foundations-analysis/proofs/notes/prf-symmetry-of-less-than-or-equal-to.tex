\newpage
\phantomsection
\label{prf:symmetry-of-less-than-or-equal-to}
\LRAProofFor{thm:symmetry-of-less-than-or-equal-to}

\begin{remark*}[Return]
\hyperref[thm:symmetry-of-less-than-or-equal-to]{Return to Theorem}
\end{remark*}
