\newpage
\phantomsection
\label{prf:landau-successor-plus}
\LRAProofFor{lem:landau-successor-plus}

\begin{remark*}[Return]
\hyperref[lem:landau-successor-plus]{Return to Lemma}
\end{remark*}

\begin{lemma*}[\texorpdfstring{
  \hyperref[prf:landau-successor-plus]
