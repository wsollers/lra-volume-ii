\section{Intervals as Subsets of $\mathbb{R}$}
\label{sec:intervals-as-subsets}

\begin{topicbox}{Intervals as the Basic Pieces}
\begin{exposition}
The interval shapes and the order-convexity characterization were established in \S\ref{sec:intervals-on-a-number-line}. Here they are recast as subsets of the metric line and supplemented with boundedness, which is the size condition compactness will need.
\end{exposition}
\end{topicbox}
\begin{tcolorbox}[colback=defbox, colframe=defborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Definition (Bounded Subset of the Real Line)}},
...
\begin{itemize}
  ...
  \item TODO: link to absolute value on $\mathbb{R}$.
\end{itemize}
\end{dependencies}
