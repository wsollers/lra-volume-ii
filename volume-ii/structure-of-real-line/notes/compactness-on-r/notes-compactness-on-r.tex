\section{Compactness on $\mathbb{R}$}
...
\begin{tcolorbox}[colback=defbox, colframe=defborder, arc=2pt,
  ...
  title={\small\textbf{Definition (Compact Set in $\mathbb{R}$)}},
...
\begin{dependencies}
\begin{itemize}
  \item \hyperref[def:open-cover]{Open Cover}
  \item \hyperref[def:finite-subcover]{Subcover and Finite Subcover}
\end{itemize}
\end{dependencies}
\begin{tcolorbox}[colback=thmbox, colframe=thmborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Theorem (Compact Subsets of $\mathbb{R}$ Are Closed and Bounded)}},
  fonttitle=\small\bfseries]
