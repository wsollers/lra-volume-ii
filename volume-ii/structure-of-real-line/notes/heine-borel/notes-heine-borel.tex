\section{Heine--Borel for Closed Bounded Intervals}
...
\begin{itemize}
  ...
  \item \hyperref[thm:dedekind-complete]{Dedekind Completeness of $\mathbb{R}$}
  \item \hyperref[thm:cantor-nested]{Cantor Nested Interval Principle}
\end{itemize}
\end{dependencies}
