...
\begin{tcolorbox}[colback=defbox, colframe=defborder, arc=2pt,
  ...
  title={\small\textbf{Definition (Interior Point)}},
...
\begin{tcolorbox}[colback=defbox, colframe=defborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Definition (Exterior Point)}},
  fonttitle=\small\bfseries]
...
\begin{tcolorbox}[colback=defbox, colframe=defborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Definition (Boundary Point)}},
  fonttitle=\small\bfseries]
...
\begin{tcolorbox}[colback=defbox, colframe=defborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Definition (Interior of a Set)}},
  fonttitle=\small\bfseries]
