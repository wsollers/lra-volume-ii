...
\begin{tcolorbox}[colback=defbox, colframe=defborder, arc=2pt,
  ...
  title={\small\textbf{Definition (Open Set in $\mathbb{R}$)}},
...
An open set has interior room around each of its points: you can always step a little in either direction and stay inside. The empty set and $\mathbb{R}$ are open, and open intervals are the model examples.
\end{remark*}
\begin{dependencies}
\begin{itemize}
...
\begin{tcolorbox}[colback=thmbox, colframe=thmborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Theorem (Open Intervals Are Open)}},
  fonttitle=\small\bfseries]
...
\begin{tcolorbox}[colback=thmbox, colframe=thmborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Theorem (Unions and Finite Intersections of Open Sets)}},
  fonttitle=\small\bfseries]
