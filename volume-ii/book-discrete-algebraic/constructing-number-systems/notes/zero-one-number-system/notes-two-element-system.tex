...
\hyperref[prf:two-element-system-is-field]{\textit{Go to proof.}}
\end{theorem}
\end{theorembox}
...
\hyperref[prf:two-element-system-not-ordered-field]{\textit{Go to proof.}}
\end{theorem}
\end{theorembox}
...
\subsection*{As Modular Arithmetic}
...
\hyperref[prf:z-mod-two-is-two-element-system]{\textit{Go to proof.}}
\end{theorem}
\end{theorembox}
