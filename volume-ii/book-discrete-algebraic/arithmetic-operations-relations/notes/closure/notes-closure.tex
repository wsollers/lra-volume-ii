...
\[
\operatorname{BinaryOperation}(O,K).
\]
\end{remark*}
...
\]
\hyperref[prf:operation-left-respect]{\textit{Go to proof.}}
\end{lemma}
\end{lemmabox}
...
\]
\hyperref[prf:operation-right-respect]{\textit{Go to proof.}}
\end{lemma}
\end{lemmabox}
...
\hyperref[prf:induced-operation-well-defined]{\textit{Go to proof.}}
\end{theorem}
\end{theorembox}
...
\begin{remark*}[Predicate reading]
\[
\operatorname{WellDefinedBinaryOperation}(\overline{O},A/{\sim})
\Longleftrightarrow
\operatorname{RepresentativeIndependent}(O,\sim,A).
\]
\end{remark*}
