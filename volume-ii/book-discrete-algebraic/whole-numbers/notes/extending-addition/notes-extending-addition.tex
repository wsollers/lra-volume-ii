...
\[
\operatorname{WellDefinedBinaryOperation}(+_{\mathbb{W}},\mathbb{W})
\quad\text{and}\quad
...
\begin{theorembox}{Theorem (Left Additive Identity on \texorpdfstring{$\mathbb{W}$}{W})}
\begin{theorem}[Left Additive Identity on $\mathbb{W}$]
\label{thm:left-additive-identity-on-w}
For every $a\in\mathbb{W}$,
\[
0+_{\mathbb{W}}a=a.
\]
\hyperref[prf:left-additive-identity-on-w]{Go to proof.}
\end{theorem}
\end{theorembox}

\begin{remark*}[Standard quantified statement]
\[
\forall a\in\mathbb{W}\;(0+_{\mathbb{W}}a=a).
\]
\end{remark*}

\begin{remark*}[Interpretation]
The element $0$ acts as an identity when it is placed on the left side of
...
\begin{theorembox}{Theorem (Right Additive Identity on \texorpdfstring{$\mathbb{W}$}{W})}
\begin{theorem}[Right Additive Identity on $\mathbb{W}$]
\label{thm:right-additive-identity-on-w}
For every $a\in\mathbb{W}$,
\[
a+_{\mathbb{W}}0=a.
\]
\hyperref[prf:right-additive-identity-on-w]{Go to proof.}
\end{theorem}
\end{theorembox}

\begin{remark*}[Standard quantified statement]
\[
\forall a\in\mathbb{W}\;(a+_{\mathbb{W}}0=a).
\]
\end{remark*}

\begin{remark*}[Interpretation]
The element $0$ acts as an identity when it is placed on the right side of
addition on $\mathbb{W}$.
\end{remark*}
...
\begin{remark*}[Predicate reading]
\[
\operatorname{Associative}(\mathbb{W},+_{\mathbb{W}}).
\]
\end{remark*}
...
\begin{remark*}[Predicate reading]
\[
\operatorname{Commutative}(\mathbb{W},+_{\mathbb{W}}).
\]
\end{remark*}
...
\begin{remark*}[Predicate reading]
\[
\operatorname{LeftCancellation}(\mathbb{W},+_{\mathbb{W}}).
\]
\end{remark*}
