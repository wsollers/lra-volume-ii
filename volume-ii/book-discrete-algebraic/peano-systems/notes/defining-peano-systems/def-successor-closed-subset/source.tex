...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:successor-closed-subset}{lra-lean}{LRA.VolumeII.PeanoSystems.TexSkeleton}{SuccessorClosedSubset}{pending}
\LeanFormalizes{def:successor-closed-subset}{lra-lean}{LRA.VolumeII.PeanoSystems.PeanoSystem}{successor_closed_subset}{pending}
