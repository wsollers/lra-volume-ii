...
\end{corollary}
\end{corollarybox}
\LeanFormalizes{cor:predecessor-exists-unique-away-from-one}{lra-lean}{LRA.VolumeII.PeanoSystems.BasicTheorems}{PredecessorExistsUniqueAwayFromOne}{pending}
