...
\end{corollary}
\end{corollarybox}
\LeanFormalizes{cor:unique-predecessor-characterization-away-from-one}{lra-lean}{LRA.VolumeII.PeanoSystems.TexSkeleton}{UniquePredecessorCharacterizationAwayFromOne}{pending}
