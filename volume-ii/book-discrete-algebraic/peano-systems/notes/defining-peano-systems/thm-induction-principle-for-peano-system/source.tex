...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:induction-principle-for-peano-system}{lra-lean}{LRA.VolumeII.PeanoSystems.InductionPrinciple}{InductionPrincipleForPeanoSystem}{pending}
