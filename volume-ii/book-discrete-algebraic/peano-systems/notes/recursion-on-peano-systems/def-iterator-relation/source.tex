...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:iterator-relation}{lra-lean}{LRA.VolumeII.PeanoSystems.TexSkeleton}{IteratorRelation}{pending}
\LeanFormalizes{def:iterator-relation}{lra-lean}{LRA.VolumeII.PeanoSystems.Recursion}{iterator_relation}{pending}
