...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:uniqueness-of-peano-systems-up-to-isomorphism}{lra-lean}{LRA.VolumeII.PeanoSystems.TexSkeleton}{UniquenessOfPeanoSystemsUpToIsomorphism}{pending}
