...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:uniqueness-of-peano-systems-up-to-isomorphism}{lra-lean}{LRA.VolumeII.PeanoSystems.Recursion.Iterator}{UniquenessOfPeanoSystemsUpToIsomorphism}{pending}
