...
\end{definition}
\end{definitionbox}
\LeanFormalizes{def:minimal-iterator-relation}{lra-lean}{LRA.VolumeII.PeanoSystems.TexSkeleton}{MinimalIteratorRelation}{pending}
\LeanFormalizes{def:minimal-iterator-relation}{lra-lean}{LRA.VolumeII.PeanoSystems.Recursion}{minimal_iterator_relation}{pending}
