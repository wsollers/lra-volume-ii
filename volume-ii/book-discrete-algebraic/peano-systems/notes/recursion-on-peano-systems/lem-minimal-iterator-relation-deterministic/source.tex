...
\end{lemma}
\end{lemmabox}
\LeanFormalizes{lem:minimal-iterator-relation-deterministic}{lra-lean}{LRA.VolumeII.PeanoSystems.TexSkeleton}{MinimalIteratorRelationDeterministic}{pending}
