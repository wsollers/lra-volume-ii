...
\end{theorem}
\end{theorembox}
\LeanFormalizes{thm:general-recursion-theorem-for-peano-system}{lra-lean}{LRA.VolumeII.PeanoSystems.TexSkeleton}{GeneralRecursionTheoremForPeanoSystem}{pending}
