...
\]
\hyperref[prf:equality-symmetry]{\textit{Go to proof.}}
\end{theorem}
\end{theorembox}
...
\begin{dependencies}
\begin{itemize}
  \item \hyperref[thm:axiomatic-equality-symmetry]{Axiomatic Symmetry of Equality}
...
\]
\hyperref[prf:equality-transitivity]{\textit{Go to proof.}}
\end{theorem}
\end{theorembox}
...
\begin{dependencies}
\begin{itemize}
  \item \hyperref[thm:axiomatic-equality-transitivity]{Axiomatic Transitivity of Equality}
  \item \hyperref[ax:leibniz-law]{Leibniz's Law}
  \item \hyperref[ax:equality-reflexivity]{Reflexivity of Equality}
...
\hyperref[prf:equality-is-equivalence-relation]{\textit{Go to proof.}}
\end{corollary}
\end{corollarybox}
...
\begin{dependencies}
\begin{itemize}
  \item \hyperref[thm:axiomatic-equality-equivalence-relation]{Axiomatic Equality as an Equivalence Relation}
  \item \hyperref[ax:equality-reflexivity]{Reflexivity of Equality}
  \item \hyperref[thm:equality-symmetry]{Symmetry of Equality}
