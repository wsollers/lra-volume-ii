...
\]
\hyperref[prf:substitution-preserves-predicates]{\textit{Go to proof.}}
\end{proposition}
\end{propositionbox}
...
\]
\hyperref[prf:substitution-preserves-relations-left]{\textit{Go to proof.}}
\end{proposition}
\end{propositionbox}
...
\]
\hyperref[prf:substitution-preserves-relations-right]{\textit{Go to proof.}}
\end{proposition}
\end{propositionbox}
...
\]
\hyperref[prf:substitution-preserves-relations-full]{\textit{Go to proof.}}
\end{proposition}
\end{propositionbox}

\begin{remark*}[St
andard quantified statement]
\[
\forall x,x',y,y',\,
...
\]
\hyperref[prf:substitution-preserves-functions]{\textit{Go to proof.}}
\end{proposition}
\end{propositionbox}
...
\]
\hyperref[prf:substitution-preserves-operations-left]{\textit{Go to proof.}}
\end{proposition}
\end{propositionbox}
...
\]
\hyperref[prf:substitution-preserves-operations-right]{\textit{Go to proof.}}
\end{proposition}
\end{propositionbox}
...
\]
\hyperref[prf:substitution-preserves-operations-full]{\textit{Go to proof.}}
\end{proposition}
\end{propositionbox}

\begin{remark*}[Standard quantified statemen
t]
\[
\forall x,x',y,y',\,
\bigl(x=x'\land y=y'\bigr)
...
displayed arguments.
\hyperref[prf:congruence-with-respect-to-equality-is-automatic]{\textit{Go to proof.}}
\end{proposition}
\end{propositionbox}
