...
\[
x=y \Longrightarrow \operatorname{Indiscernible}(x,y).
\]
\end{remark*}
...
\begin{itemize}
  \item \hyperref[def:relation]{Relation}
  \item \hyperref[def:axiomatic-equality-structure]{Equality Structure}
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item \hyperref[def:identity-relation]{Identity}
  \item \hyperref[def:equality-relation]{Equality on a Domain}
\end{itemize}
\end{dependencies}
