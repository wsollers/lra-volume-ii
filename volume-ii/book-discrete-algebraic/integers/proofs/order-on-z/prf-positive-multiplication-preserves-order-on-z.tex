\newpage
\phantomsection
\label{prf:positive-multiplication-preserves-order-on-z}
\LRAProofFor{thm:positive-multiplication-preserves-order-on-z}

\begin{remark*}[Return]
\hyperref[thm:positive-multiplication-preserves-order-on-z]{Return to Theorem}
\end{remark*}

\begin{theorem*}[Multiplication by Positives Preserves Order on $Z$]
