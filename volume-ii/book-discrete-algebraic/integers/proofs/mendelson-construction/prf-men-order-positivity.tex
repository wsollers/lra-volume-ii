\newpage
\phantomsection
\label{prf:men-order-positivity}
\LRAProofFor{thm:men-order-positivity}

\begin{remark*}[Return]
\hyperref[thm:men-order-positivity]{Return to Theorem}
\end{remark*}
...
\LRAProofBodyStart
TODO: professional standard proof for men-order-positivity.
\end{proof}

\begin{proof}[Detailed Learning Proof]
\LRAProofBodyStart
TODO: detailed learning proof for men-order-positivity.
\end{proof}
