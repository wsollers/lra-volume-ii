\newpage
\phantomsection
\label{prf:divisibility-compatible-with-negation-on-z}
\LRAProofFor{prop:divisibility-compatible-with-negation-on-z}

\begin{remark*}[Return]
\hyperref[prop:divisibility-compatible-with-negation-on-z]{Return to Theorem}
\end{remark*}

\begin{proposition*}[Divisibility Is Compatible with Negation on $Z$]
