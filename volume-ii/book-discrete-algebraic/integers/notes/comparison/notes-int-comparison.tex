...
\clearpage
\subsection*{Tao vs.\ Mendelson: Integer Theory --- Statement-by-Statement Comparison}
...
Euclidean division (\S{}5, Thm 5.1)
& Thm 5.1
& No
& \textbf{Proof sheet} --- classical and useful
\\[6pt]

Divisibility properties (\S{}5, Thm 5.2)
& Thm 5.2 (11 parts)
& No
& \textbf{Proof sheet} --- good algebraic practice
\\[6pt]

GCD existence and B\'{e}zout (Thm 5.3)
& Thm 5.3
& No
...
Modular arithmetic (\S{}6)
& Thms 6.1--6.6
& No
& \textbf{Skip} for now; revisit in algebra track
\\[6pt]

Integer action on domains (\S{}7, Thms 7.1--7.4)
& Thms 7.1--7.4
& No
& \textbf{Skip} --- graduate algebra
\\[6pt]

$N_\mathcal{D}$, $Z_\mathcal{D}$ embedding theory (\S{}8)
& Thms 8.1--8.9
& No
& \textbf{Skip} --- graduate algebra
\\[6pt]

Subdomain theory (\S{}9, Thms 9.1--9.4)
& Thms 9.1--9.4
& No
& \textbf{Skip} --- graduate algebra
\\[6pt]
...
number theory: Euclidean division, divisibility, GCD, primes (\S{}5).

\medskip
\textbf{Skip for now (graduate algebra):}
Modular arithmetic (\S{}6), integer action on domains (\S{}7),
$N_\mathcal{D}$/$Z_\mathcal{D}$ embedding theory (\S{}8--9).
