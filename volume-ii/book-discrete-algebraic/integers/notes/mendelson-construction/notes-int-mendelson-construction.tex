...
% ---------------------------------------------------------
% \S{}3.1  The equivalence relation on P \times P
% ---------------------------------------------------------
\subsection*{\texorpdfstring{\S{}3.1 \quad The Equivalence Relation on $P \times P$}{S3.1 quad The Equivalence Relation on P x P}}
...
% ---------------------------------------------------------
% \S{}3.2  Addition and Multiplication
% ---------------------------------------------------------
\subsection*{\S{}3.2 \quad Addition and Multiplication}
...
% ---------------------------------------------------------
% \S{}3.3  Rings and Integral Domains (abstract)
% ---------------------------------------------------------
\subsection*{\S{}3.3 \quad Rings and Integral Domains (Abstract Theory)}
...
% \S{}4  Order
% ---------------------------------------------------------
\subsection*{\texorpdfstring{\S{}4 \quad Ordered Integral Domains and Order on $\mathbb{Z}$}{S4 quad Ordered Integral Domains and Order on Z}}
...
% \S{}4  Absolute Value
% ---------------------------------------------------------
\subsection*{\S{}4 \quad Absolute Value}
...
% \S{}5  Number theory
% ---------------------------------------------------------
\subsection*{\S{}5 \quad Division, Divisibility, Primes}
...
Standard divisibility properties, existence and B\'{e}zout form of gcd,
...
% ---------------------------------------------------------
% \S{}6  Modular arithmetic
% ---------------------------------------------------------
\subsection*{\texorpdfstring{\S{}6 \quad Integers Modulo $n$ (Optional)}{S6 quad Integers Modulo n (Optional)}}
...
% ---------------------------------------------------------
% \S{}7--9  Structural theory
% ---------------------------------------------------------
\subsection*{\texorpdfstring{\S{}7--9 \quad Integer Action, Embedding Theory, Uniqueness of $\mathbb{Z}$}{S7--9 quad Integer Action, Embedding Theory, Uniqueness of Z}}
