...
% ---------------------------------------------------------
\section*{\texorpdfstring{\S{}3.1 \quad The Equivalence Relation on $P \times P$}{S3.1 quad The Equivalence Relation on P x P}}
...
% ---------------------------------------------------------
\section*{\S{}3.2 \quad Addition and Multiplication}
...
% ---------------------------------------------------------
\section*{\S{}3.3 \quad Rings and Integral Domains (Abstract Theory)}
...
% \S{}4  Order
% ---------------------------------------------------------
\section*{\texorpdfstring{\S{}4 \quad Ordered Integral Domains and Order on $\mathbb{Z}$}{S4 quad Ordered Integral Domains and Order on Z}}
...
% \S{}4  Absolute Value
% ---------------------------------------------------------
\section*{\S{}4 \quad Absolute Value}
...
% \S{}5  Number theory
% ---------------------------------------------------------
\section*{\S{}5 \quad Division, Divisibility, Primes}
...
% ---------------------------------------------------------
\section*{\texorpdfstring{\S{}6 \quad Integers Modulo $n$ (Optional)}{S6 quad Integers Modulo n (Optional)}}
...
% ---------------------------------------------------------
\section*{\texorpdfstring{\S{}7--9 \quad Integer Action, Embedding Theory, Uniqueness of $\mathbb{Z}$}{S7--9 quad Integer Action, Embedding Theory, Uniqueness of Z}}
