...
\begin{tcolorbox}[colback=axiombox, colframe=axiomborder, arc=2pt,
  ...
  title={\small\textbf{One-Based Peano Axioms for $\mathbb{N}$}},
...
% ---------------------------------------------------------
\subsection{The Whole Numbers $\mathbb{W}$}

\begin{tcolorbox}[colback=axiombox, colframe=axiomborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{$\mathbb{W}$ as $\mathbb{N}$ with an Adjoined Zero}},
  fonttitle=\small\bfseries]
...
% ---------------------------------------------------------
\subsection{Structural Comparison: $\mathbb{N}$, $\mathbb{W}$, $\mathbb{Z}$, $\mathbb{Q}$, $\mathbb{R}$}
