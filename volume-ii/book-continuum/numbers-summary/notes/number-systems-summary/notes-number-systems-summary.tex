...
% File: volume-ii/book-continuum/numbers-summary/notes/notes-number-systems-summary.tex
% =========================================================
...
\begin{topicbox}{One-Based Peano Axioms for $\mathbb{N}$}
\begin{exposition}
...
\begin{topicbox}{$\mathbb{W}$ as $\mathbb{N}$ with an Adjoined Zero}
\begin{exposition}
...
\begin{topicbox}{Axioms for $\mathbb{Z}$ --- Ordered Commutative Ring}
\begin{exposition}
