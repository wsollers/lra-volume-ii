% =========================================================
% The Nested Interval Construction of $\mathbb{R}$ (Cantor)
% =========================================================

\subsection{\texorpdfstring{Nested Interval Construction of $\mathbb{R}$ (Cantor)}{Nested Interval Construction of R (Cantor)}}
...
\begin{definitionbox}{Definition (Nested Interval Sequence)}
\begin{definition}[Nested Interval Sequence]\label{def:nested-intervals}
...
\begin{definitionbox}{Definition (Diameter / Length)}
\begin{definition}[Diameter / Length]\label{def:diameter}
...
\begin{theorembox}{Theorem (Cantor Nested Interval Principle)}
...
\begin{definitionbox}{Definition (Real Number via Nested Rational Intervals)}
\begin{definition}[Real Number via Nested Rational Intervals]\label{def:real-as-nested}
...
\begin{propositionbox}{Remark (Endpoints approximate the same point)}
