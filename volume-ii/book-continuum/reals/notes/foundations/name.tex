...
\begin{dependencies}
Missing formal dependency targets for metric spaces:
\begin{itemize}
  \item definition of sequential compactness;
  \item compact subsets of metric spaces are closed;
  \item arbitrary intersections of closed subsets of a metric space are closed;
  \item closed subsets of compact metric spaces are compact;
  \item closed subsets contain limits of convergent sequences.
\end{itemize}
\end{dependencies}
