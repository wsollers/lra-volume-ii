...
\begin{description}
  ...
  \item[\(\operatorname{Interval}\) fails.] The predicate fails exactly in the displayed negation case:
  \[
  I\text{ is not an interval}
  \Longleftrightarrow
  \exists x,z\in I\;\exists y\in\mathbb{R}\;
...
\input{volume-ii/book-continuum/number-lines/notes/intervals-on-a-number-line/figure-interval-classification}
