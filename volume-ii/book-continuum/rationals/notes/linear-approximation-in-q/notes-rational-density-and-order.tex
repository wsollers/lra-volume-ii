...
% ---------------------------------------------------------
\begin{theorembox}{Theorem (Between Any Two Rational Numbers Lies Another Rational)}
...
% ---------------------------------------------------------
\begin{theorembox}{Theorem ($\mathbb{Q}$ Has No Minimum Positive Element)}
...
% ---------------------------------------------------------
\begin{theorembox}{Theorem (Rational Chain with Uniformly Small Steps)}
