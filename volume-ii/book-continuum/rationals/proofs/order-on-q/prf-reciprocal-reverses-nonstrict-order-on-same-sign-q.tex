\newpage
\phantomsection
\label{prf:reciprocal-reverses-nonstrict-order-on-same-sign-q}
\LRAProofFor{thm:reciprocal-reverses-nonstrict-order-on-same-sign-q}

\begin{remark*}[Return]
\hyperref[thm:reciprocal-reverses-nonstrict-order-on-same-sign-q]{Return to Theorem}
\end{remark*}
...
\LRAProofBodyStart
TODO: professional standard proof for reciprocal-reverses-nonstrict-order-on-same-sign-q.
\end{proof}

\begin{proof}[Detailed Learning Proof]
\LRAProofBodyStart
TODO: detailed learning proof for reciprocal-reverses-nonstrict-order-on-same-sign-q.
\end{proof}
