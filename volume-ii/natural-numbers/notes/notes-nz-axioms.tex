% =========================================================
% Reference Page: Axiom Systems for N, W, and Z
% File: volume-ii/integers/notes/notes-nz-axioms-reference.tex
% =========================================================

\section{Reference: Axiom Systems for $\mathbb{N}$, $\mathbb{W}$, and $\mathbb{Z}$}
...
\begin{axiombox}{Peano Axioms for $\mathbb{N}$ (Tao \S2.1)}
...
\begin{axiombox}{Axioms for $\mathbb{Z}$ as an Ordered Commutative Ring}
...
\begin{remark*}[What $\mathbb{Z}$ gains over $\mathbb{W}$]
The decisive addition is \textbf{A4}: additive inverses.
$\mathbb{W}$ satisfies A1--A3, M1--M3, D, and O1--O5,
but it has no additive inverses ($3 - 5 \notin \mathbb{W}$).
$\mathbb{Z}$ is obtained from $\mathbb{W}$ by formally adjoining
additive inverses, making subtraction always defined.
\end{remark*}
...
\begin{tcolorbox}[colback=gray!6, colframe=gray!40, arc=2pt,
  ...
  title={\small\textbf{Axiom Comparison: $\mathbb{N}$, $\mathbb{W}$, $\mathbb{Z}$,
         $\mathbb{Q}$, $\mathbb{R}$}},
...
\midrule
Addition    & A1 commutativity          & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark \\
...
\midrule
Multiplication & M1 commutativity       & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark \\
...
\midrule
Order       & O1--O3 total order        & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark \\
            & O4--O5 order + arithmetic & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark \\
\midrule
Completeness & Least upper bound        & $\times$   & $\times$   & $\times$   & $\times$   & \checkmark \\
\midrule
\multicolumn{2}{@{}l}{\textbf{Structure}} &
\textit{positive arithmetic} & \textit{semiring} & \textit{ring} & \textit{field} &
\textit{complete} \\
