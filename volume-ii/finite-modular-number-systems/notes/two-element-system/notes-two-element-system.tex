...
\begin{remark*}[Standard quantified statement]
The two-element number system is the carrier B_2 equipped with its addition, multiplication, zero, and one.
\end{remark*}
...
\begin{remark*}[Standard quantified statement]
The structure F_2 satisfies the field axioms.
\end{remark*}
...
\begin{remark*}[Standard quantified statement]
No order on B_2 makes F_2 satisfy the ordered-field axioms.
\end{remark*}
