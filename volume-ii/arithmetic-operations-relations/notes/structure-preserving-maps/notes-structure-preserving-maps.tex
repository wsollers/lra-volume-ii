...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{def:injective-homomorphism}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{def:abstract-order-embedding}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{def:structure-embedding}.
\end{itemize}
\end{dependencies}
