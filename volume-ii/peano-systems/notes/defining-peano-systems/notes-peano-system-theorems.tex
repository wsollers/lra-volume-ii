...
\begin{tcolorbox}[colback=thmbox, colframe=thmborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Theorem (Successor Inequality Reflection)}} ,
  fonttitle=\small\bfseries]
...
\begin{tcolorbox}[colback=corbox, colframe=corborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Corollary (Non-One Elements Have a Predecessor)}} ,
  fonttitle=\small\bfseries]
...
\begin{tcolorbox}[colback=corbox, colframe=corborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Corollary (Unique Predecessor Characterization Away from \texorpdfstring{$1$}{1})}} ,
  fonttitle=\small\bfseries]
