...
\includegraphics[width=\textwidth,height=0.78\textheight,keepaspectratio]
  {volume-ii/peano-systems/notes/defining-peano-systems/diag_04_signature-asset.pdf}
...
\centering
\includegraphics[width=\textwidth,height=0.78\textheight,keepaspectratio]
  {volume-ii/peano-systems/notes/defining-peano-systems/diag_01_rstar_intuitive-asset.pdf}
...
\centering
\includegraphics[width=\textwidth,height=0.78\textheight,keepaspectratio]
  {volume-ii/peano-systems/notes/defining-peano-systems/diag_02_rstar_formal-asset.pdf}
...
\centering
\includegraphics[width=\textwidth,height=0.78\textheight,keepaspectratio]
  {volume-ii/peano-systems/notes/defining-peano-systems/diag_03_arity_examples-asset.pdf}
...
\centering
\includegraphics[width=\textwidth,height=0.78\textheight,keepaspectratio]
  {volume-ii/peano-systems/notes/defining-peano-systems/diag_05_parallel_chains-asset.pdf}
...
\centering
\includegraphics[width=\textwidth,height=0.78\textheight,keepaspectratio]
  {volume-ii/peano-systems/notes/defining-peano-systems/diag_06_three_zone-asset.pdf}
