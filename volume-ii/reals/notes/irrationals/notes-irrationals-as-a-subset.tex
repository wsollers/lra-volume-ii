...
\section{Irrationals as a Subset of the Real Line}
...
\begin{tcolorbox}[colback=thmbox, colframe=thmborder, arc=2pt,
  ...
  title={\small\textbf{Theorem (Density of $\mathbb{Q}$ in $\mathbb{R}$)}},
...
\end{tcolorbox}
\begin{dependencies}
The Archimedean property of $\mathbb{R}$, the floor lemma, and the fact that
$\mathbb{Q}$ is closed under ratios of integers by positive natural numbers.
\end{dependencies}
...
\begin{tcolorbox}[colback=corbox, colframe=corborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Corollary (Infinitely Many Rational Numbers Lie Between Two Distinct Reals)}},
  fonttitle=\small\bfseries]
...
\begin{tcolorbox}[colback=thmbox, colframe=thmborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Theorem (Between Any Two Real Numbers Lies an Irrational)}},
  fonttitle=\small\bfseries]
...
\begin{tcolorbox}[colback=corbox, colframe=corborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Corollary (The Irrationals Are Dense in $\mathbb{R}$)}},
  fonttitle=\small\bfseries]
...
\begin{tcolorbox}[colback=corbox, colframe=corborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Corollary (Every Irrational Can Be Approximated by Rationals)}},
  fonttitle=\small\bfseries]
...
\begin{tcolorbox}[colback=corbox, colframe=corborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Corollary (Every Rational Can Be Approximated by Irrationals)}},
  fonttitle=\small\bfseries]
...
\begin{tcolorbox}[colback=thmbox, colframe=thmborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Theorem (Closure of $\mathbb{Q}$ in $\mathbb{R}$)}},
  fonttitle=\small\bfseries]
...
\begin{tcolorbox}[colback=corbox, colframe=corborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Corollary ($\mathbb{Q}$ Is Not Closed in $\mathbb{R}$)}},
  fonttitle=\small\bfseries]
...
\begin{tcolorbox}[colback=corbox, colframe=corborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Corollary ($\mathbb{Q}$ Is Not Open in $\mathbb{R}$)}},
  fonttitle=\small\bfseries]
...
\begin{tcolorbox}[colback=corbox, colframe=corborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Corollary ($\mathbb{Q}$ Is Not Discrete in $\mathbb{R}$)}},
  fonttitle=\small\bfseries]
...
\begin{tcolorbox}[colback=thmbox, colframe=thmborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Theorem (The Irrationals Are Uncountable)}},
  fonttitle=\small\bfseries]
...
\end{tcolorbox}
\begin{dependencies}
The real numbers are uncountable and the rational numbers are countable.
\end{dependencies}
\begin{remark*}[Proof idea]
...
\begin{tcolorbox}[colback=thmbox, colframe=thmborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Theorem (The Irrationals Are Not Complete as an Ordered Set)}},
  fonttitle=\small\bfseries]
...
\end{tcolorbox}
\begin{dependencies}
The order on $\mathbb{R}$ and the irrational subset $\mathbb{R}\setminus\mathbb{Q}$.
\end{dependencies}
\begin{remark*}[Proof idea]
Consider the set
\[
