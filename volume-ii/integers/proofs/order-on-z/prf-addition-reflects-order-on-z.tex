\newpage
\phantomsection
\label{prf:addition-reflects-order-on-z}
\LRAProofFor{cor:addition-reflects-order-on-z}

\begin{remark*}[Return]
\hyperref[cor:addition-reflects-order-on-z]{Return to Theorem}
\end{remark*}

\begin{corollary*}[Addition Reflects Order on $Z$]
