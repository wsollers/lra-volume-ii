\newpage
\phantomsection
\label{prf:addition-preserves-strict-order-on-z}
\LRAProofFor{thm:addition-preserves-strict-order-on-z}

\begin{remark*}[Return]
\hyperref[thm:addition-preserves-strict-order-on-z]{Return to Theorem}
\end{remark*}

\begin{theorem*}[Addition Preserves Strict Order on $Z$]
