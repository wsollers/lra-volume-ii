\newpage
\phantomsection
\label{prf:left-addition-preserves-order-on-z}
\LRAProofFor{thm:left-addition-preserves-order-on-z}

\begin{remark*}[Return]
\hyperref[thm:left-addition-preserves-order-on-z]{Return to Theorem}
\end{remark*}

\begin{theorem*}[Left Addition Preserves Order on $Z$]
