\newpage
\phantomsection
\label{prf:addition-on-z-well-defined}
\LRAProofFor{thm:addition-on-z-well-defined}

\begin{remark*}[Return]
\hyperref[thm:addition-on-z-well-defined]{Return to Theorem}
\end{remark*}

\begin{theorem*}[Addition on $Z$ Is Well-Defined]
