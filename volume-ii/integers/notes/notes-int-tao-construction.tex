...
% ---------------------------------------------------------
\begin{toolkitbox}{Integer Toolkit — Tao §4.1 Quick Reference}
\small
\begin{tabular}{l l l}
\toprule
...
% ---------------------------------------------------------
\begin{propositionbox}{Definition 4.1.1 (Integers)}
...
% ---------------------------------------------------------
\begin{propositionbox}{Definition 4.1.2 (Addition and Multiplication)}
\[
(a {-\!\!-} b) + (c {-\!\!-} d) \;:=\; (a+c) {-\!\!-} (b+d)
\]
\[
...
% ---------------------------------------------------------
\begin{propositionbox}{Definition 4.1.4 (Negation)}
$-(a {-\!\!-} b) \;:=\; b {-\!\!-} a$.
...
% ---------------------------------------------------------
\begin{propositionbox}{Proposition 4.1.6 (Laws of Algebra for $\mathbb{Z}$)}
...
% ---------------------------------------------------------
\begin{propositionbox}{Definition 4.1.10 (Ordering of $\mathbb{Z}$)}
Let $n, m \in \mathbb{Z}$.
\[
