...
Canonical overlay: docs/governance/repo-overlays/lra-volume-ii.md
...
Canonical repo overlay: `docs/governance/repo-overlays/lra-volume-ii.md`
Canonical route resolver:
`python <governance-root>/capabilities/resolve.py --repo lra-volume-ii --task "<user task>" --root <repo-root>`
