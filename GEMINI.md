...
Canonical overlay: capabilities/overlays/lra-volume-ii.md
...
Repository: `lra-volume-ii`
Canonical repo overlay: `capabilities/overlays/lra-volume-ii.md`
Canonical route resolver:
`python <governance-root>/scripts/govpy.py capabilities/resolve.py --repo lra-volume-ii --task "<user task>" --root <repo-root>`
